      ...
      <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-8">
        <div className="flex items-center gap-3 group">
          <div className="w-10 h-10 rounded-full overflow-hidden flex items-center justify-center transition-transform duration-300 group-hover:scale-110">
            <img src="/shalomcleans.webp" alt="Shalomcleans Logo" width="40" height="40" loading="lazy" decoding="async" className="w-full h-full brightness-0 dark:invert object-contain" />
          </div>
          <span className="font-display font-semibold tracking-tight text-obsidian dark:text-white text-sm uppercase">Shalomcleans</span>
        </div>
        <div className="text-xs text-obsidian/40 dark:text-white/40 font-medium tracking-widest uppercase text-center md:text-left">
          © 2026 Shalomcleans. Pristine Spaces, Peaceful Hearts.
        </div>
